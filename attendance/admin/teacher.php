        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                <input type="text" name="teacher_emailid" id="teacher_emailid" class="form-control" disabled="true" />
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                <input type="password" name="teacher_password" id="teacher_password" class="form-control" disabled="true" />
...
$(document).ready(function(){
  ...
  $('#add_button').click(function(){
    ...
    $('#teacher_emailid').prop('disabled', false);
    $('#teacher_password').prop('disabled', false);
    clear_field();
  });
  ...
  $(document).on('click', '.edit_teacher', function(){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        $('#action').val('Edit');
        $('#formModal').modal('show');
        $('#teacher_emailid').prop('disabled', true);
        $('#teacher_password').prop('disabled', true);
